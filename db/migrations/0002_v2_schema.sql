-- ============================================================================
-- 0002 — v2 NORMALIZED SCHEMA (as-applied record)
-- ============================================================================
-- Verbatim copy of sql_v2_migration.sql from the original repo. This is
-- ALREADY APPLIED to the live database; it is committed here so the repo
-- records what was applied and so local/CI databases can be built.
